...
goog.exportSymbol('proto.notes.SayRequest', null, global);
...
goog.exportSymbol('proto.notes.Note1', null, global);
...
proto.notes.Note1 = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.notes.Note1, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.notes.Note1.displayName = 'proto.notes.Note';
}
...
proto.notes.SayRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.notes.SayRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.notes.SayRequest.displayName = 'proto.notes.SayRequest';
}
...
proto.notes.SayRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.notes.SayRequest.toObject(opt_includeInstance, this);
};
...
proto.notes.SayRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: msg.getName()
  };
...
proto.notes.SayRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.notes.SayRequest;
  return proto.notes.SayRequest.deserializeBinaryFromReader(msg, reader);
};
...
proto.notes.SayRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
...
proto.notes.SayRequest.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
...
proto.notes.SayRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
...
proto.notes.SayRequest.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getName();
  if (f.length > 0) {
    writer.writeString(
...
proto.notes.SayRequest.prototype.cloneMessage = function() {
  return /** @type {!proto.notes.SayRequest} */ (jspb.Message.cloneMessage(this));
};
...
proto.notes.SayRequest.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 1, ""));
};
...
proto.notes.SayRequest.prototype.setName = function(value) {
  jspb.Message.setField(this, 1, value);
};
