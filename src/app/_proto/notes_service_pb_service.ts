...
export namespace Note1Service {
  export class SayHello {
    static readonly methodName = "SayHello";
    static readonly service = Note1Service;
    static readonly requestStream = false;
    static readonly responseStream = false;
    static readonly requestType = notes_service_pb.SayRequest;
    static readonly responseType = notes_service_pb.Note1;
  }
